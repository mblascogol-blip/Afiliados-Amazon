...
export const products: Product[] = [
  ...
  { slug: "mtb-evercross-aluminio-suspension", categorySlug: "bicicletas-convencionales", name: "MTB 26\"", brand: "Evercross", price: "399€", rating: 4.5, reviewCount: 0, image: "https://m.media-amazon.com/images/I/71-TJ7D4tXL._AC_SL1500_.jpg", badge: "Mejor relación calidad-precio", specs: [{ label: "Cuadro", value: "Aluminio" }, { label: "Suspensión", value: "Completa" }, { label: "Cambio", value: "Shimano, 21v" }, { label: "Frenos", value: "Disco mecánico" }], pros: ["Buena relación calidad-precio en bicicletas de montaña convencionales", "Cambio Shimano fiable a un precio muy por debajo de la media", "Suspensión completa, cómoda en pistas con piedra suelta"], cons: ["Componentes de gama de entrada, no para uso intensivo de competición", "Llantas básicas, mejorables a medio plazo"], summary: "El punto de entrada perfecto a montaña sin motor: componentes Shimano fiables a precio de entrada.", affiliateUrl: "https://amzn.to/4gfGcXc" },
